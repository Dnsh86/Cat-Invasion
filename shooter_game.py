...
img_back = "galaxy.jpeg"  # game background
img_bullet = "peluru.jpeg"  # bullet
img_hero = "opalhelmet.jpg"  # hero
img_enemy = "milo.jpg"  # enemy
...
background = transform.scale(image.load("galaxy.jpeg"),(win_width,win_height))
# create sprites
ship_w = 50
ship_h = 50
ship_s = 10
